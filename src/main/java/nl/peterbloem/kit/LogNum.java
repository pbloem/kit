...
import nl.peterbloem.kit.LogNum.LogNumList;

/**
 * A number stored as the logarithm of its magnitude and its sign.
 * 
 * This is a utility class for the old trick of storing very small probabilities
 * (and other values) by their logarithm. It takes care of tricky stuff like 
 * negative values, and summing values stored as logarithms.
 *  
 * @author Peter
 */
